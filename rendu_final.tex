...
\rhead{3M03} %: On personnalisera cette en-tête. haut de page droite
...
\date{2013 \\ ~\\
\begin{centering}
\includegraphics[width=0.85\textwidth]{titre}
\end{centering}
\addcontentsline{lof}{figure}{\protect\numberline{}Image de couverture}
}
\maketitle
...
pour moins de deux cent francs. Équipé de répétiteurs, un groupe d'UGV
pourraient couvrir une grande zone sans mettre en danger ses pilotes
puisqu'ils restent à l'écart. Ce drone peut servir en cas de catastrophes
naturelles, néanmoins, notre modèle ne peut pas rouler sur les terrains trop
accidentés, mais pour corriger ce problème, il suffit tout simplement
...
car il est étroitement lié à la mécanique et il permet une meilleure
compréhension du reste. Ce chapitre décrit principalement l'ordinateur et le
