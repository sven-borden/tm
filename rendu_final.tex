...
Pour programmer l'Arduino, nous utilisons le logiciel dédié, \textit{Arduino}, C'est un environnement \textit{open-source} qui fonctionne sur Windows, Linux et Mac OS X. Il a été écrit en Java et est basé sur le logiciel Processing.
\begin{figure}[h!]
\begin{center}
