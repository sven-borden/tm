...
Voici un schéma du chip:\ref{SchemaPlaqueMaison}
...
\end{figure}
(PHOTO + EXPLICATIONS)
Et quelques exemples de plaques similaires à celle que nous avons trouvée:\ref{rx2.1} \ref{rx2.2} \ref{rx2.3}

\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{figures/rx2_ex1.jpg}
    \caption{\label{rx2.1}Schéma sommaire de la plaque.
    }
\end{figure}
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{figures/rx2_ex2.jpg}
    \caption{\label{rx2.2}Schéma sommaire de la plaque.
    }
\end{figure}
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{figures/rx2_ex3.jpg}
    \caption{\label{rx2.3}Schéma sommaire de la plaque.
    }
\end{figure}
...
(PHOTO DESCRIPTIVE)\ref{PPFigure}
...
Tous ces composants, en plus des câbles et des connecteurs vers les actuateurs et batterie, sont soudés sur une strip board semblable à celle dans la photo ci dessous:\ref{StripBoard}
...
(PHOTO SCHEMA complet chine arduino)\ref{schemaChineComplet}
\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{figures/schema_CHI.PNG}
...
\subsection{Design}
(PHOTO DESIGN CHINE)\ref{board_CHI}

\begin{figure}[h]
\centering
\includegraphics[width=1.0\textwidth]{board_CHI.PNG}
    \caption{\label{board_CHI} Design de la plaque imprimée en Chine
    }
\end{figure}
